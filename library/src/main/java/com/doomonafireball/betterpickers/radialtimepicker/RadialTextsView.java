...
public class RadialTextsView extends View {
    ...
    public void initialize(Resources res, String[] texts, String[] innerTexts,
        ...
        // Set up the paint.
        int numbersTextColor = res.getColor(R.color.bp_numbers_text_color);
    ...
    /* package */ void setTheme(Context context, boolean themeDark) {
        ...
        int textColor;
        if (themeDark) {
            textColor = res.getColor(R.color.bp_white);
        } else {
            textColor = res.getColor(R.color.bp_numbers_text_color);
        }
