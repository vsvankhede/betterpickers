    ...
    public static String getRepeatString(Context context, Resources r, EventRecurrence recurrence,
        ...
        if (includeEndString) {
            ...
            if (recurrence.until != null) {
                ...
                t.set(TimeUnit.SECONDS.toMillis(recurrence.until));
        ...
        switch (recurrence.freq) {
            ...
            case EventRecurrence.WEEKLY: {
                return r.getQuantityString(R.plurals.weekly_zh, interval, interval) + endString;
                /*
            ...
            case EventRecurrence.YEARLY:
                return r.getQuantityString(R.plurals.yearly_zh, interval, interval) + endString;
